...
\JLoader::register('TplGourmandHelper', JPATH_THEMES . '/gourmand/helper.php');
$loginDescriptionShow = TplGourmandHelper::checkNull($this->params->get('logindescription_show'));
$loginDescription = TplGourmandHelper::checkNull($this->params->get('login_description'));
...
<div class="login<?php echo $this->pageclass_sfx; ?>">
	<div class="row justify-content-center">
		<div class="col-lg-12">
			...
			<?php if (($this->params->get($loginDescriptionShow) == 1 && str_replace(' ', '', $this->params->get($loginDescription)) != '') || $this->params->get('login_image') != '') : ?>
				<div class="login-description">
				<?php endif; ?>

				<?php if ($this->params->get($loginDescriptionShow) == 1) : ?>
					<?php echo $this->params->get($loginDescription); ?>
				<?php endif; ?>
