...
<form action="<?php echo JRoute::_('index.php?option=com_vikrestaurants&view=opkitchen' . ($itemid ? '&Itemid=' . $itemid : '')); ?>" method="POST" name="opkitchenform">
	...
	<input type="hidden" name="view" value="opkitchen" />
