...
/**
 * VikRestaurants operator dashboard view.
 *
 * @since 1.6
 */
class VikRestaurantsViewopdashboard extends JViewVRE
{	
	/**
	...
	function display($tpl = null)
	{
		...
		// retrieve filters
		$filters = array();
		$filters['date']      = $app->getUserStateFromRequest('vreopdash.date', 'date', '', 'string');
		$filters['intervals'] = $app->getUserStateFromRequest('vreopdash.intervals', 'intervals', null, 'uint');
