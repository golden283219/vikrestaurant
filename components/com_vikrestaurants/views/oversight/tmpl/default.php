...
if ($user->id)
{
	...
	<div class="vrloginwarning">
		...
		<div class="vrloginwarningtext">
			<?php echo JText::sprintf('VRLOGINOPERATORNOTFOUND', $user->name); ?>
		</div>
		
		<div class="vrloginwarningexit">
			<a href="<?php echo JRoute::_('index.php?option=com_vikrestaurants&task=oversight.logout' . ($itemid ? '&Itemid=' . $itemid : '')); ?>" class="vrloginwarningexitlink">
...
else
{
	...
	$data = array(
		 ...
		 */
		'return' => 'index.php?option=com_vikrestaurants&view=oversight' . ($itemid ? '&Itemid=' . $itemid : ''),
