...
$data = array(
	 ...
	 */
	'register' => $config->getBool('enablereg', false) || $config->getBool('tkenablereg', false),

	/**
	 * @param 	string  return 		The return URL used after the login.
	 *								The URL must be plain (non-routed).
	 */
	'return' => 'index.php?option=com_vikrestaurants&view=allorders' . ($itemid ? '&Itemid=' . $itemid : ''),
