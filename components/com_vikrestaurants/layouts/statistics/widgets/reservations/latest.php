		...
		<table>
			...
			<thead>
				<tr>
					...
					<!-- Table -->
					<th width="18%" style="text-align: left;"><?php echo JText::_('VRMANAGERESERVATION5'); ?></th>
					<!-- Status -->
					<th width="17%" style="text-align: left;"><?php echo JText::_('VRMANAGERESERVATION12'); ?></th>
				</tr>
			</thead>
						...
						<td>
							...
							<span class="td-pull-right actions-group">
								...
								if ($r->status == 'CONFIRMED')
								{
									...
									{
										?>
										<a href="javascript: void(0);" onclick="reservationsNotifyEvent(<?php echo $r->id; ?>, <?php echo $widget->getID(); ?>, this);">
								...
								{
									?>
									<a href="javascript: void(0);" onclick="reservationsConfirmEvent(<?php echo $r->id; ?>, <?php echo $widget->getID(); ?>, this);">
										<i class="fas fa-check-circle ok"></i>
									</a>

									<a href="javascript: void(0);" onclick="reservationsRefuseEvent(<?php echo $r->id; ?>, <?php echo $widget->getID(); ?>, this);">
