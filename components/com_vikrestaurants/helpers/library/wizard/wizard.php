 ...
 * @since 1.8.3
 */
class VREWizard implements ArrayAccess, IteratorAggregate
{
	/**
	 * Singleton property.
	 *
	...
	public function setup(array $steps = array())
	{
		 ...
		 * @since 	1.8.2
		 */
		$dispatcher->trigger('onSetupVikRestaurantsWizard', array(&$this));
		...
		foreach ($steps as $step)
		{
			try
			{
				if (!$step instanceof VREWizardStep)
				{
		 ...
		 * @since 	1.8.2
		 */
		$dispatcher->trigger('onAfterSetupVikRestaurantsWizard', array(&$this));
	}
	 ...
	 *
	 * @param 	integer        $index  The index to access.
	 * @param 	VREWizardStep  $step   The step to add.
	 *
	 * @return 	self  This object to support chaining.
	 */
	public function setStep($index, VREWizardStep $step)
	{
	...
	public function indexOf($id)
	{
		...
		$id = $id instanceof VREWizardStep ? $id->getID() : (string) $id;
	 ...
	 * @return 	self  This object to support chaining.
	 */
	public function addStep(VREWizardStep $step, $index = null)
	{
	 ...
	 * @return 	self  This object to support chaining.
	 */
	public function addStepAfter(VREWizardStep $step, $id)
	{
	 ...
	 * @return 	self  This object to support chaining.
	 */
	public function addStepBefore(VREWizardStep $step, $id)
	{
		// find index in which the step is located
		$index = $this->indexOf($id);
	 ...
	 *
	 * @param 	mixed 	       $key    Either the step ID or an index.
	 * @param 	VREWizardStep  $value  The step to add.
	 *
	 * @return 	void
	 */
