...
abstract class VREWizardStep
{
	...
	public function addDependency()
	{
		...
		foreach (func_get_args() as $step)
		{
			...
			if ($step instanceof VREWizardStep && !$this->hasDependency($step))
			{
	 ...
	 *
	 * @param 	VREWizardStep  $step  The step to check.
	 *
	 * @return 	boolean  True in case of dependency, false otherwise
	 */
	public function hasDependency(VREWizardStep $step)
	{
	...
	public function getExecuteButton()
	{
		...
		return '<button type="button" class="btn btn-success" data-role="process">' . JText::_('VRSAVE') . '</button>';
	}
