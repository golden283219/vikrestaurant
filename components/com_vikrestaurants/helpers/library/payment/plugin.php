...
final class VREPaymentPlugin
{
	...
	public function __construct($driver, $order, $params = array())
	{
		 ...
		 */
		$this->dispatcher = VREFactory::getEventDispatcher();
	}
	...
	public function showPayment()
	{
		 ...
		 * @since 	1.8.5
		 */
		$results = $this->dispatcher->trigger('onStartPaymentTransaction', array('vikrestaurants', $this->driver, $this->order, $this->params));
	...
	public function validatePayment()
	{
		 ...
		 */
		VRELoader::import('library.payment.status');
		$status = new VREPaymentStatus();
		 ...
		 * @param 	string            $element  The component that triggered this event.
		 * @param 	string            $payment  The ID of the payment driver.
		 * @param 	VREPaymentStatus  $status   The object holding the payment status.
		 * @param 	JRegistry         $order    The order info registry.
		 * @param 	JRegistry         $params   The payment configuration saved through the fields
		 *                                      generated by onLoadPaymentMethodConfigurationForm.
		 *
		 ...
		 * @since 	1.8.5
		 */
		$this->dispatcher->trigger('onValidatePaymentTransaction', array('vikrestaurants', $this->driver, $status, $this->order, $this->params));
	...
	public function afterValidation($result = false)
	{
		 ...
		 * @since 	1.8.5
		 */
		$this->dispatcher->trigger('onCompletePaymentTransaction', array('vikrestaurants', $this->driver, $result, $this->order, $this->params));
	}
	...
	public function refund()
	{
		 ...
		 * @since 	1.8.5
		 */
		$this->dispatcher->trigger('onRefundPaymentTransaction', array('vikrestaurants', $this->driver, $status, $this->order, $this->params));
