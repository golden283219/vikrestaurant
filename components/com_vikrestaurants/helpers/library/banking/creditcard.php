...
abstract class CreditCard
{
	 ...
	 * @param 	integer 	$cvc 			The CVC, CVV or CV2.
	...
	{
		$this->cvc = (int) preg_replace('/\D/', '', $cvc);
	 ...
	 *
	 * @return 	integer 	The card CVC, CVV or CV2.
	 */
	...
	public function setExpiryYear($year)
	{
		...
		if ($year < 1000) {
			$now = getdate();
			$year = intval(substr($now['year'], 2).$year);
		}
	 ...
	 */
	public abstract function isCardNumberValid();
	 ...
	 */
	public abstract function getCardNumberDigits();
	 ...
	 */
	public abstract function formatCardNumber();
	 ...
	 */
	public abstract function getMaskedCardNumber();
	 ...
	 */
	public abstract function getBrandAlias();
	 ...
	 */
	public abstract function getBrandName();
