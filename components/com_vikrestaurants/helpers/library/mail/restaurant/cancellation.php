...
class VREMailTemplateRestaurantCancellation implements VREMailTemplate
{
	 ...
	 */
	public function __construct($res, $langtag = null, array $options = array())
	{
		if (!$langtag)
		{
	...
	public function getSubject()
	{
		...
		$res = VREMailFactory::letPluginsManipulateMail('restaurant', 'cancellation', 'subject', $subject, $this->reservation);
	...
	public function getHtml()
	{
		...
		$order_link_href = 'index.php?option=com_vikrestaurants&view=reservations&ids[]=' . $this->reservation->id;
		...
		$placeholders = array(
			...
			'cancellation_content' => JText::_('VRRESCANCELLEDCONTENT'),
		...
		$res = VREMailFactory::letPluginsManipulateMail('restaurant', 'cancellation', 'content', $tmpl, $this->reservation);
	...
	public function send()
	{
		...
		// iterate all the operators that should be notified (1 = restaurant)
