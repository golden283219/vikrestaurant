...
class VersionRecognizer
{
	...
	/**
	 * Checks if the installed Joomla is 1.5 or 1.8	 *
	...
	/**
	 * Checks if the installed Joomla is between 3.5 and 3.6.
	 *
	 * @return 	boolean  True if Joomla is between 3.0 and 3.6, otherwise false.
	 */
	...
	/**
	 * Checks if the installed Joomla is between 3.7 and 4.0 (excluded).
	 *
	 * @return 	boolean  True if Joomla is between 3.7 and 4.0 (excluded), otherwise false.
	 */
	...
	/**
	 * Checks if the installed CMS is supported.
	 * The CMS version is not supported when the class is not able
	 * to recognize the installed version.
	 *
	 * @return 	boolean  True if the CMS version is supported, otherwise false.
	 */
