...
class SppagebuilderAddonImage_content extends SppagebuilderAddons
{
	...
	public function render()
	{
		...
		if ($image_alignment === 'left') {
			$content_class = ' sppb-col-offset-6';
		} else {
			$content_class = '';
		}
		...
		if ($image_src && $text) {
			...
			if ($image_alignment === 'left') {
				$output .= '<div class="sppb-col-6 sppb-col-md-6 sppb-col-sm-12 sppb-col-xs-12"></div>';
			}

			$output .= '<div class="sppb-col-6 sppb-col-md-6 sppb-col-sm-12 sppb-col-xs-12' . $content_class . '">';
	...
	public static function getTemplate()
	{
		...
		<div class="sppb-addon sppb-addon-image-content aligment-{{ data.image_alignment }} clearfix {{ data.class }}">
			...
			<div class="sppb-container">
				<div class="sppb-row">
					<# if(data.image_alignment == "left") { #>
						<div class="sppb-col-6 sppb-col-md-6 sppb-col-sm-12 sppb-col-xs-12"></div>
					<# } #>
					<div class="sppb-col-6 sppb-col-md-6 sppb-col-sm-12 sppb-col-xs-12 {{ content_class }}">
