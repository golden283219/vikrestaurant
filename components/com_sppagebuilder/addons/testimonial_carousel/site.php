...
class SppagebuilderAddonTestimonial_carousel extends SppagebuilderAddons
{
    ...
    public function render()
    {
        ...
        $carousel_item_number_xxl = (isset($settings->carousel_item_number_original->xxl) && $settings->carousel_item_number_original->xxl) ? $settings->carousel_item_number_original->xxl : 3;
		...
		data-item-number-xxl="' . $carousel_item_number_xxl . '"
    ...
    public function css()
    {
        ...
        //Message style
        $itemContentProps = [
            'message_margin_bottom' => 'margin-bottom',
    ...
    public static function getTemplate()
    {
		...
		#>
			<div class="sppb-addon sppb-carousel-extended {{data.class}} sppb-testimonial-carousel-{{data.testimonial_carousel_layout}}"
				...
				data-item-number-xxl="{{carousel_item_number_xxl || 3}}"
