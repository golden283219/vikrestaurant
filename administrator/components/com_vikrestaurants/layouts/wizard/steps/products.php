...
<ul class="wizard-step-summary">
	<?php
	$products = $step->getProducts();

	// display at most 4 products
	for ($i = 0; $i < min(array(4, count($products))); $i++)
	{
		?>
		<li>
			<i class="fas fa-<?php echo $products[$i]->published ? 'check-circle ok' : 'dot-circle no'; ?> medium"></i>
