					...
					<div class="kitchen-wall-block">
						...
						<div class="wall-block-head">
							...
							<div class="block-head-actions">
								<a href="index.php?option=com_vikrestaurants&task=reservation.editbill&cid[]=<?php echo $res->id; ?>&from=restaurant">
						...
						<div class="wall-block-list">
							...
							if (count($res->dishes) == 0)
							{
								...
								<div style="padding: 10px;">
									<?php echo $vik->alert(JText::_('JGLOBAL_NO_MATCHING_RESULTS'), 'warning', false, array('style' => 'margin: 0;')); ?>
								</div>
								<?php
							}
							else
		...
		jQuery('.vrdash-container.kitchen[data-widget="<?php echo $widget->getID(); ?>"]')
			.find('.vrrescodelink').each(function() {
				jQuery(this).statusCodesPopup({
					group: 3,
					controller: '<?php echo $vik->ajaxUrl('index.php?option=com_vikrestaurants&task=resprod.changecodeajax&tmpl=component'); ?>',
