...
/**
 * Integration between VikRestaurants and Cardboardfish provider.
 *
 * @since 1.5
 */
class VikSmsApi
...
class SMS {
	...
	public function __construct($da = "", $sa = "", $msg = "", $sat = "", $dcs = "", $dr = "", $udh = "", $ur = "", $vp = "", $du = "", $lt = "") {
