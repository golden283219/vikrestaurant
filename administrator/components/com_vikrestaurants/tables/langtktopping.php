...
/**
 * VikRestaurants language take-away topping table.
 *
 * @since 1.8
 */
class VRETableLangtktopping extends JTableVRE
{
	/**
	 * Class constructor.
	 *
	...
	{
		parent::__construct('#__vikrestaurants_lang_takeaway_topping', 'id', $db);
