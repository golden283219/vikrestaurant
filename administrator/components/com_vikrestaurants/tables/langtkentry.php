...
/**
 * VikRestaurants language take-away menu entry table.
 *
 * @since 1.8
 */
class VRETableLangtkentry extends JTableVRE
{
	/**
	 * Class constructor.
	 *
	...
	{
		parent::__construct('#__vikrestaurants_lang_takeaway_menus_entry', 'id', $db);
	...
	public function bind($src, $ignore = array())
	{
		...
		if (!empty($src['alias']))
		{
			...
			$src['alias'] = VRESefHelper::getUniqueAlias($src['alias'], 'tkentry', $src['id_entry'], $id_parent);
		}
	...
	public function delete($ids = null)
	{
		...
		// delete lang options belonging to deleted entries
		$q = $dbo->getQuery(true)
		...
		// delete lang groups belonging to deleted entries
		$q = $dbo->getQuery(true)
