...
/**
 * VikRestaurants language custom field table.
 *
 * @since 1.8
 */
class VRETableLangcustomf extends JTableVRE
{
	/**
	 * Class constructor.
	 *
	...
	{
		parent::__construct('#__vikrestaurants_lang_customf', 'id', $db);
	...
	public function bind($src, $ignore = array())
	{
		...
		if (isset($src['choose']) && is_array($src['choose']))
		{
			...
			$src['choose'] = implode(';;__;;', $src['choose']);
		}
	...
	public function delete($ids = null)
	{
		...
		$q = $dbo->getQuery(true)
			->delete($dbo->qn('#__vikrestaurants_lang_customf'))
