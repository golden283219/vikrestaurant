...
class VikRestaurantsControllerRoomclosure extends VREControllerAdmin
{
	...
	public function save()
	{
		...
		// get record table
		$closure = JTableVRE::getInstance('roomclosure', 'VRETable');

		// try to save arguments
		if (!$closure->save($args))
		{
			// get string error
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&task=roomclosure.edit&cid[]=' . $closure->id);
	...
	public function delete()
	{
		...
		JTableVRE::getInstance('roomclosure', 'VRETable')->delete($cid);
