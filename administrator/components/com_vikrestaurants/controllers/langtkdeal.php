...
class VikRestaurantsControllerLangtkdeal extends VREControllerAdmin
{
	...
	public function add()
	{
		...
		$app->setUserState('vre.langtkdeal.data', array());
	...
	public function save()
	{
		...
		// get record table
		$langdeal = JTableVRE::getInstance('langtkdeal', 'VRETable');

		// try to save arguments
		if (!$langdeal->save($args))
		{
			// get string error
		...
		$this->setRedirect('index.php?option=com_vikrestaurants&task=langtkdeal.edit&cid[]=' . $langdeal->id);
	...
	public function delete()
	{
		...
		JTableVRE::getInstance('langtkdeal', 'VRETable')->delete($cid);
