		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			<tr class="row<?php echo $kk; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&amp;task=langtkattribute.edit&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
						<?php
					}
					else
					{
...
?>
	...
	<input type="hidden" name="view" value="langtkattributes" />
	<input type="hidden" name="id_attribute" value="<?php echo $filters['id_attribute']; ?>" />
