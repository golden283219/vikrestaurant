	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span12">
			...
			<div class="row-fluid">
				...
				<div class="span6">
					<?php
					echo $vik->openFieldset(JText::_('VRMANAGERESERVATIONTITLE1'));
				...
				<div class="span6">
					...
					if (count($this->customFields))
					{
						...
						<div class="row-fluid">
							<div class="span12">
								<?php
								echo $vik->openFieldset(JText::_('VRMANAGERESERVATIONTITLE2'));
					...
					if (count($this->allMenus))
					{
						?>
						<div class="row-fluid">
							<div class="span12">
								<?php
								echo $vik->openFieldset(JText::_('VRMENUMENUS'));
			...
			<div class="row-fluid">
				<div class="span12">
					<?php
					echo $vik->openFieldset(JText::_('VRMANAGERESERVATIONTITLE3'));
					echo $editor->display('notes', $reservation->notes, 400, 200, 70, 20);
					echo $vik->closeFieldset();
					?>
				</div>
			</div>
...
echo JHtml::_(
	...
	'jmodal-busytime',
	array(
		'title'       => JText::_('VRRESBUSYMODALTITLE'),
		'closeButton' => true,
		'keyboard'    => true, 
		'bodyHeight'  => 80,
...
<script>
	...
	function vrOpenJModal(id, url, jqmodal) {
		if (id == 'busytime') {
			// busy table
			url = 'index.php?option=com_vikrestaurants&view=restbusyres&tmpl=component&date=' + jQuery('#vrdatefilter').val() + '&time=' + jQuery('#vr-hour-sel').val();
