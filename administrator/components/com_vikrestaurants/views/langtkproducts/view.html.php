...
class VikRestaurantsViewlangtkproducts extends JViewVRE
{
	...
	private function addToolBar()
	{
		...
		JToolbarHelper::title(JText::_('VRMAINTITLEVIEWLANGTKPRODUCTS'), 'vikrestaurants');
		
		if (JFactory::getUser()->authorise('core.create', 'com_vikrestaurants'))
		{
			JToolbarHelper::addNew('langtkentry.add', JText::_('VRNEW'));
			JToolbarHelper::divider();
		}

		if (JFactory::getUser()->authorise('core.edit', 'com_vikrestaurants'))
		{
			JToolbarHelper::editList('langtkentry.edit', JText::_('VREDIT'));
			JToolbarHelper::spacer();
		}

		if (JFactory::getUser()->authorise('core.delete', 'com_vikrestaurants'))
		{
			JToolbarHelper::deleteList(VikRestaurants::getConfirmSystemMessage(), 'langtkentry.delete', JText::_('VRDELETE'));
		}
