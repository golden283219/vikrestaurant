		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			<tr class="row<?php echo $kk; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&amp;task=langtkentry.edit&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
						<?php
					}
					else
					{
...
?>
	...
	<input type="hidden" name="view" value="langtkproducts" />
	<input type="hidden" name="id_entry" value="<?php echo $this->filters['id_entry']; ?>" />
	<input type="hidden" name="id_takeaway_menu" value="<?php echo $this->filters['id_takeaway_menu']; ?>" />
