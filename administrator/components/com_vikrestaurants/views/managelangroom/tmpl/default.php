...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span6">
			...
			<div class="row-fluid">
				...
				<div class="span12">
					<?php echo $vik->openFieldset(JText::_('VRMANAGEROOMCLOSURE1')); ?>
				...
				<div class="span12">
					...
					echo $editor->display('description', isset($this->struct->lang_description) ? $this->struct->lang_description : '', 400, 200, 70, 20);
		...
		<div class="span6">
			<?php echo $vik->openFieldset(JText::_('VRE_LANG_ORIGINAL')); ?>
				...
				<?php echo $vik->openControl(JText::_('VRMANAGELANG3')); ?>
					<textarea class="full-width" style="height:300px;resize:vertical;" readonly tabindex="-1"><?php echo $this->struct->description; ?></textarea>
				<?php echo $vik->closeControl(); ?>
	...
	<input type="hidden" name="id_room" value="<?php echo $this->struct->id_room; ?>" />	
