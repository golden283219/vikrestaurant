		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			<tr class="row<?php echo $kk; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&amp;task=langtkmenu.edit&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
						<?php
					}
					else
					{
...
?>
	...
	<input type="hidden" name="view" value="langtkmenus" />
	<input type="hidden" name="id_menu" value="<?php echo $this->filters['id_menu']; ?>" />
