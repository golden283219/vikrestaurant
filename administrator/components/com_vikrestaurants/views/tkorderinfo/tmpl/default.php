...
<style>
	...
	/* overwrite scroll for take-away */

	.order-container.takeaway .order-left-box,
	.order-container.takeaway .order-right-box {
		overflow-y: scroll;
		height: 100%;
	}
	.order-container.takeaway .order-left-box .order-left-bottom-box,
	.order-container.takeaway .order-right-box .order-status-history {
		overflow-y: hidden;
		height: auto;
		max-height: 100%;
		margin-bottom: 12px;
	}
	.order-container.takeaway .order-right-box .order-payment-details {
		height: auto;
	}
...
<div class="order-container takeaway">
