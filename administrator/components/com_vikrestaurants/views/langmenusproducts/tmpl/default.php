	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="<?php echo $vik->getAdminTableClass(); ?>">
		<?php echo $vik->openTableHead(); ?>
			<tr>
				...
				<th class="<?php echo $vik->getAdminThClass('left'); ?>" width="20%" style="text-align: left;"><?php echo JText::_('VRMANAGELANG2');?></th>
				<th class="<?php echo $vik->getAdminThClass('left hidden-phone'); ?>" width="40%" style="text-align: left;"><?php echo JText::_('VRMANAGELANG3');?></th>
		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			{
				$desc = JText::_('JOPTION_USE_DEFAULT');
			}
			?>
			<tr class="row<?php echo $kk; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&amp;task=langmenusproduct.edit&amp;cid[]=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
						<?php
					}
					else
					{
...
?>
	...
	<input type="hidden" name="view" value="langmenusproducts" />
	<input type="hidden" name="id_product" value="<?php echo $filters['id_product']; ?>" />
