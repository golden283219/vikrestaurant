		...
		for ($i = 0; $i < count($rows); $i++)
		{
			...
			<tr class="row<?php echo $kk; ?>">
				...
				<td>
					...
					{
						?>
						<a href="index.php?option=com_vikrestaurants&task=langtkdeal.edit&cid[]=<?php echo $row['id']; ?>"><?php echo $name; ?></a>
						<?php
					}
					else
					{
...
?>
	...
	<input type="hidden" name="view" value="langtkdeals" />
	<input type="hidden" name="id_deal" value="<?php echo $filters['id_deal']; ?>" />
