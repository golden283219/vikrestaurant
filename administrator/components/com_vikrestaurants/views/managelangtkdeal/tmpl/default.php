...
<form name="adminForm" action="index.php" method="post" id="adminForm">
	...
	<?php echo $vik->openCard(); ?>
		...
		<div class="span6">
			...
			<div class="row-fluid">
				...
				<div class="span12">
					<?php echo $vik->openFieldset(JText::_('VRTKDEALFIELDSET1')); ?>
						...
						<input type="hidden" name="id" value="<?php echo isset($this->struct->id_lang) ? $this->struct->id_lang : ''; ?>" />
				...
				<div class="span12">
					...
					echo $vik->getEditor()->display('description', isset($this->struct->lang_description) ? $this->struct->lang_description : '', 400, 200, 70, 20);
	...
	<input type="hidden" name="id_deal" value="<?php echo $this->struct->id_deal; ?>" />
